...
const carServices = [
  ...
  },
  {
    ...
    features: ["Rộng rãi thoải mái", "Hành lý nhiều", "Ghế ngồi êm ái", "Điều hòa mạnh mẽ", "An toàn cao"],
    popular: true,
  },
  {
    name: "Xe 16 chỗ",
...
const packages = [
  {
    ...
    features: ["Xe 4 chỗ đời mới", "Tài xế kinh nghiệm", "Nhiên liệu đầy đủ", "Bảo hiểm cơ bản", "Hỗ trợ 24/7"],
    popular: false,
  },
  {
    name: "Gói Tiêu Chuẩn",
